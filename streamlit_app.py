...
Do not give a long and general answer, depending on the information you have you can ask for specifics to provide the specific answer.
...
if st.session_state.messages[-1]["role"] != "assistant":
    with st.chat_message("assistant"):
        with st.spinner("Typing..."):
            ...
            # Collect feedback for the current response
